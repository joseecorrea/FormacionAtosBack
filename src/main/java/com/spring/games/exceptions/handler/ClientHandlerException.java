...
@ControllerAdvice
public class ClientHandlerException extends ResponseEntityExceptionHandler {

	@ResponseStatus(HttpStatus.OK)
	@ExceptionHandler({ ClientNotFoundException.class })
	@ResponseBody
	public ErrorDto handleGameNotFound(HttpServletRequest request, ClientNotFoundException exception) {
		return new ErrorDto("01", exception.getDetalle());
	}
	
	@ResponseStatus(HttpStatus.OK)
	@ExceptionHandler({ ClientIsAlreadySetException.class })
	@ResponseBody
	public ErrorDto handleIsAlreadySet(HttpServletRequest request, ClientIsAlreadySetException exception) {
